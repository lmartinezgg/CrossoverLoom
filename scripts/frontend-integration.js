 ...
 * This file demonstrates how to integrate Crossoverloom with a web frontend
 */

// For React/Vue/Angular applications
export class CrossoverloomClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CrossoverloomClient(provider, contractAddress);
