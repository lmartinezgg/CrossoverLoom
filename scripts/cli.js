...
const contractABI = require("../artifacts/contracts/Crossoverloom.sol/Crossoverloom.json").abi;

program
    .name("crossoverloom-cli")
    .description("CLI tool for Crossoverloom smart contract")
    .version("1.0.0");
